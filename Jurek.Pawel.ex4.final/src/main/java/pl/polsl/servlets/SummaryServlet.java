...
public class SummaryServlet extends HttpServlet {
     ...
     * methods.
     * Downloads the studentGradebook set in the session, reads the subjects, grades from it
     * and sets the necessary data in the request. If the file is correct, it redirects
     * to summary display, if not, then to index.html, where you can attach the file again
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(studentGradebook != null){
            // Set attributes
            request.setAttribute("pageTitle", "Summary Page");
            request.setAttribute("subjectsList", studentGradebook.getSubjects());
