...
public class StudentGradebookTest {
    ...
    static Stream<Arguments> gradebookData() throws InvalidGradeException {
        return Stream.of(
            ...
            Arguments.of(
                List.of(
                    new Subject("Science", List.of(new PartialGrade(4.0, 3), new PartialGrade(1.0, 2))),
                    new Subject("English", List.of(new PartialGrade(3.0, 2), new PartialGrade(4.0, 2)))
                ),
                3.25 // Expected final grade
            )
        );
    }
    ...
    public void testCalculateFinalGrade(List<Subject> subjects, double expectedFinalGrade) {
        try {
            ...
            double actualFinalGrade = gradebook.getFinalGrade();
